...
const (
	...
	PingServiceEchoProcedure = "/ping.v1.PingService/Echo"
	// PingServicePingStreamProcedure is the fully-qualified name of the PingService's PingStream RPC.
	PingServicePingStreamProcedure = "/ping.v1.PingService/PingStream"
)
...
// Echo calls ping.v1.PingService.Echo.
...
// PingStream calls ping.v1.PingService.PingStream.
...
func (UnimplementedPingServiceHandler) Echo(context.Context, *connect.Request[v1.EchoRequest]) (*connect.Response[v1.EchoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ping.v1.PingService.Echo is not implemented"))
}
...
func (UnimplementedPingServiceHandler) PingStream(context.Context, *connect.BidiStream[v1.PingStreamRequest, v1.PingStreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("ping.v1.PingService.PingStream is not implemented"))
}
